...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView label1 = findViewById(R.id.textLabel1);
        final TextView label2 = findViewById(R.id.textLabel2);
        final TextView txtBirthday = (TextView)findViewById(R.id.textBirthday);
        final TextView txtGender = (TextView)findViewById(R.id.textGender);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EditText txtBx = (EditText)findViewById(R.id.txtBx);
